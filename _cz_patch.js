...
const SPEC = {
  '坚果r2': { img: 'https://aka.doubaocdn.com/s/M0yJmyERUs', cpu_brand: '高通', cpu_model: '骁龙865', release_date: '2020-10' },
  '坚果pro3': { img: 'https://aka.doubaocdn.com/s/OtDqocmthm', cpu_brand: '高通', cpu_model: '骁龙855Plus', back_camera: '4800万四摄', release_date: '2019-10' },
  '坚果': { img: 'https://aka.doubaocdn.com/s/OtDqocmthm', release_date: '2018' },
  'r1': { img: 'https://aka.doubaocdn.com/s/M0yJmyERUs', cpu_brand: '高通', cpu_model: '骁龙845', release_date: '2018-05' },
  '锤子m1': { img: 'https://aka.doubaocdn.com/s/OtDqocmthm', cpu_brand: '高通', cpu_model: '骁龙821', release_date: '2016-10' },
  '锤子pro': { img: 'https://aka.doubaocdn.com/s/OtDqocmthm', cpu_brand: '高通', cpu_model: '骁龙660', release_date: '2017-05' },
  '锤子t2': { img: 'https://aka.doubaocdn.com/s/CK7ypTAqoI', release_date: '2015-12' },
  '锤子t1': { img: 'https://aka.doubaocdn.com/s/CK7ypTAqoI', cpu_brand: '高通', cpu_model: '骁龙801', release_date: '2014-05' },
};
...
async function main() {
  const list = await req('GET', '/api/models?brand=%E9%94%A4%E5%AD%90&limit=1000');
