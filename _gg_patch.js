...
const SPEC = {
  'pixel4': { img: 'https://aka.doubaocdn.com/s/UtddrAqCCX', cpu_brand: '高通', cpu_model: '骁龙855', release_date: '2019-10' },
  'pixel3': { img: 'https://aka.doubaocdn.com/s/ph61KofC7n', cpu_brand: '高通', cpu_model: '骁龙845', release_date: '2018-10' },
  'pixel2': { img: 'https://aka.doubaocdn.com/s/ph61KofC7n', cpu_brand: '高通', cpu_model: '骁龙835', release_date: '2017-10' },
  'pixel1': { img: 'https://aka.doubaocdn.com/s/qOQ1BPPNSF', cpu_brand: '高通', cpu_model: '骁龙821', release_date: '2016-10' },
};
...
async function main() {
  const list = await req('GET', '/api/models?brand=%E8%B0%B7%E6%AD%8C%E6%89%8B%E6%9C%BA&limit=1000');
