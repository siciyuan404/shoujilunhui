// 华硕 系列补图+补参数（ROG 游戏手机 + ZenFone 全系列）
...
const SPEC = {
  '华硕rog6': { img: 'https://aka.doubaocdn.com/s/3yV3zNlIrm', cpu_brand: '联发科', cpu_model: '天玑9000+', refresh: '165Hz', release_date: '2022-07' },
  '华硕rog5': { img: 'https://aka.doubaocdn.com/s/3yV3zNlIrm', cpu_brand: '高通', cpu_model: '骁龙888', refresh: '165Hz', release_date: '2021-03' },
  '华硕rog3': { img: 'https://aka.doubaocdn.com/s/3yV3zNlIrm', cpu_brand: '高通', cpu_model: '骁龙865Plus', refresh: '144Hz', release_date: '2020-07' },
  '华硕rog2': { img: 'https://aka.doubaocdn.com/s/3yV3zNlIrm', cpu_brand: '高通', cpu_model: '骁龙855Plus', refresh: '120Hz', release_date: '2019-07' },
  '华硕rog': { img: 'https://aka.doubaocdn.com/s/3yV3zNlIrm', cpu_brand: '高通', cpu_model: '骁龙845', refresh: '90Hz', release_date: '2018-06' },
  '华硕zenfone10': { img: 'https://aka.doubaocdn.com/s/iLAb7zCOtm', cpu_brand: '高通', cpu_model: '骁龙8Gen2', release_date: '2023-06' },
  '华硕zenfone9': { img: 'https://aka.doubaocdn.com/s/iLAb7zCOtm', cpu_brand: '高通', cpu_model: '骁龙8+Gen1', release_date: '2022-07' },
  '华硕zenfone8': { img: 'https://aka.doubaocdn.com/s/iLAb7zCOtm', cpu_brand: '高通', cpu_model: '骁龙888', release_date: '2021-05' },
  '华硕zenfone7': { img: 'https://aka.doubaocdn.com/s/iLAb7zCOtm', cpu_brand: '高通', cpu_model: '骁龙865', release_date: '2020-08' },
  '华硕zenfone6': { img: 'https://aka.doubaocdn.com/s/iLAb7zCOtm', cpu_brand: '高通', cpu_model: '骁龙855', release_date: '2019-05' },
};
...
async function main() {
  const list = await req('GET', '/api/models?brand=%E5%8D%8E%E7%A1%95%E6%99%BA%E8%83%BD%E6%89%8B%E6%9C%BA&limit=1000');
