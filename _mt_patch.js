...
const SPEC = {
  't9': { img: 'https://aka.doubaocdn.com/s/bZp5GZx7FL', cpu_brand: '高通', cpu_model: '骁龙660', screen_size: '6.01英寸', back_camera: '1200万双摄', front_camera: '1200万双摄', release_date: '2018-06' },
  '小t9': { img: 'https://aka.doubaocdn.com/s/bZp5GZx7FL', release_date: '2018' },
  't8': { img: 'https://aka.doubaocdn.com/s/bZp5GZx7FL', cpu_brand: '联发科', cpu_model: 'Helio X30', release_date: '2018-01' },
  'm8': { img: 'https://aka.doubaocdn.com/s/bZp5GZx7FL', release_date: '2017-06' },
  'm6': { img: 'https://aka.doubaocdn.com/s/bZp5GZx7FL', release_date: '2016-06' },
  'm4': { img: 'https://aka.doubaocdn.com/s/bZp5GZx7FL', release_date: '2016-06' },
  'm2': { img: 'https://aka.doubaocdn.com/s/bZp5GZx7FL', release_date: '2015-05' },
  'v7': { img: 'https://aka.doubaocdn.com/s/L7KvffXDqK', release_date: '2017-09' },
  'v6': { img: 'https://aka.doubaocdn.com/s/L7KvffXDqK', back_camera: '2100万双摄', release_date: '2017' },
  'v4': { img: 'https://aka.doubaocdn.com/s/L7KvffXDqK', release_date: '2015-10' },
};
...
async function main() {
  const list = await req('GET', '/api/models?brand=%E7%BE%8E%E5%9B%BE&limit=1000');
