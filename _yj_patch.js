// 一加 系列补图+补参数（1+数字 / Ace / Turbo / Nord 全系列）
...
const SPEC = {
  '1+13': { img: 'https://aka.doubaocdn.com/s/c0T0hzzAKQ', cpu_brand: '高通', cpu_model: '骁龙8至尊版', screen_size: '6.82英寸', battery: '6000mAh', charge: '100W', release_date: '2024-10' },
  '1+12': { img: 'https://aka.doubaocdn.com/s/3V9B5UdYtK', cpu_brand: '高通', cpu_model: '骁龙8Gen3', battery: '5400mAh', charge: '100W', release_date: '2023-12' },
  '1+11': { img: 'https://aka.doubaocdn.com/s/3V9B5UdYtK', cpu_brand: '高通', cpu_model: '骁龙8Gen2', screen_size: '6.7英寸', battery: '5000mAh', charge: '100W', release_date: '2023-01' },
  '1+10': { img: 'https://aka.doubaocdn.com/s/3V9B5UdYtK', cpu_brand: '高通', cpu_model: '骁龙8Gen1', release_date: '2022-01' },
  '1+9': { img: 'https://aka.doubaocdn.com/s/3V9B5UdYtK', cpu_brand: '高通', cpu_model: '骁龙888', release_date: '2021-03' },
  '1+8': { img: 'https://aka.doubaocdn.com/s/3V9B5UdYtK', cpu_brand: '高通', cpu_model: '骁龙865', release_date: '2020-04' },
  '1+7': { img: 'https://aka.doubaocdn.com/s/9A31holwVw', cpu_brand: '高通', cpu_model: '骁龙855', screen_size: '6.67英寸', release_date: '2019-05' },
  '1+6': { img: 'https://aka.doubaocdn.com/s/9A31holwVw', cpu_brand: '高通', cpu_model: '骁龙845', release_date: '2018-05' },
  '1+5': { img: 'https://aka.doubaocdn.com/s/9A31holwVw', cpu_brand: '高通', cpu_model: '骁龙835', release_date: '2017-06' },
  '1+3': { img: 'https://aka.doubaocdn.com/s/7nfiveVNAc', cpu_brand: '高通', cpu_model: '骁龙820', screen_size: '5.5英寸', battery: '3000mAh', charge: 'DASH闪充', release_date: '2016-06' },
  '1+2': { img: 'https://aka.doubaocdn.com/s/7nfiveVNAc', cpu_brand: '高通', cpu_model: '骁龙810', release_date: '2015-08' },
  '1+nord': { img: 'https://aka.doubaocdn.com/s/RRZhQluVJU', cpu_brand: '高通', cpu_model: '骁龙765G', release_date: '2020-07' },
  '一加ace': { img: 'https://aka.doubaocdn.com/s/kgfUGnENEw', cpu_brand: '高通', cpu_model: '第三代骁龙8', release_date: '2024-12' },
  '一加turbo': { img: 'https://aka.doubaocdn.com/s/kgfUGnENEw', release_date: '2025' },
};
...
async function main() {
  const list = await req('GET', '/api/models?brand=%E4%B8%80%E5%8A%A0&limit=1000');
