...
const SPEC = {
  'z6': { img: 'https://aka.doubaocdn.com/s/ApOscgb47j', release_date: '2019' },
  'z5': { img: 'https://aka.doubaocdn.com/s/ApOscgb47j', cpu_brand: '高通', cpu_model: '骁龙710', release_date: '2018-11' },
  's5': { img: 'https://aka.doubaocdn.com/s/ApOscgb47j', release_date: '2018' },
  'k12': { img: 'https://aka.doubaocdn.com/s/psVj5U96Wk', release_date: '2020' },
  'k5': { img: 'https://aka.doubaocdn.com/s/psVj5U96Wk', screen_size: '5.5英寸', battery: '3500mAh', back_camera: '1300万像素', release_date: '2016-01' },
  'r0g6': { img: 'https://aka.doubaocdn.com/s/psVj5U96Wk', release_date: '2017' },
  'zuk': { img: 'https://aka.doubaocdn.com/s/WTI3QEIn4N', cpu_brand: '高通', cpu_model: '骁龙820', screen_size: '5英寸', battery: '3500mAh', release_date: '2016' },
  '拯救者': { img: 'https://aka.doubaocdn.com/s/ykXZlGaFwg', cpu_brand: '高通', cpu_model: '骁龙8Gen1', release_date: '2022-02' },
};
...
async function main() {
  const list = await req('GET', '/api/models?brand=%E8%81%94%E6%83%B3&limit=1000');
